...
## ПЕРВЫЙ ЗАПУСК (если компоненты ещё не созданы)
...
**Порядок работы с нуля:**
1. Прочитай этот файл целиком.
2. Прочитай `src/data/content.json` — там вся структура данных.
3. Прочитай `src/lib/i18n.js` — там все UI-переводы.
4. Строй компоненты по разделу «Архитектура» ниже.
5. Коммить после каждого рабочего блока и пушь в `main` → Railway задеплоит.
